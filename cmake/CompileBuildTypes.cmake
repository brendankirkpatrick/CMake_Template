...
elseif(HEADER_FILES)
    ...
    if(MAIN)
        ...
        set(HEADER_ONLY_LINK_LANG "CXX" CACHE STRING "Set the linker language for header-only tooling target")
        set_property(CACHE HEADER_ONLY_LINK_LANG PROPERTY STRINGS C CXX)
        set_target_properties(${PROJECT_NAME}_lib PROPERTIES LINKER_LANGUAGE ${HEADER_ONLY_LINK_LANG})
    endif()
...
elseif(${BUILD_TYPE} STREQUAL "Header-Only")
...
if(MAIN AND NOT BUILD_TYPE STREQUAL "Executable")
